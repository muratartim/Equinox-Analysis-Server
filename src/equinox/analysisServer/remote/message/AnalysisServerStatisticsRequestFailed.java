...
/**
 * Class for analysis server request failed network message.
 *
 * @author Murat Artim
 * @date 18 Jun 2018
 * @time 13:39:25
 */
public class AnalysisServerStatisticsRequestFailed extends AnalysisMessage {
	 ...
	 */
	public AnalysisServerStatisticsRequestFailed() {
	}
