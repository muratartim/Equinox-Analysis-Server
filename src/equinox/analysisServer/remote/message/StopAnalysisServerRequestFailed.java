...
/**
 * Class for stop analysis server request failed network message.
 * 
 * @author Murat Artim
 * @date 12 Jul 2018
 * @time 22:28:21
 */
public class StopAnalysisServerRequestFailed extends AnalysisMessage {
	 ...
	 */
	public StopAnalysisServerRequestFailed() {
	}
